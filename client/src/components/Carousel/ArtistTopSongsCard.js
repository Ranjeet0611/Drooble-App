import { Typography, Skeleton, Item } from 'antd';
      ...
      <Slider {...settings}>
        {props.newReleases.map((item) => (
          <div class="musical-container">
            ...
            <audio id={item.id} src={item.preview_url}></audio>
            <img
              style={{
                height: 250,
                objectFit: 'fill',
              ...
              alt="song-alt"
              src={item.album.images.length>0?item.album.images[0].url:noSong}
            />
            {/* </a> */}
...
export default ArtistTopSongsCard;
